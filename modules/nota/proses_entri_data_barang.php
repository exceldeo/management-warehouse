...
// jika user sudah login, maka jalankan perintah untuk insert
  ...
  if (isset($_POST['simpan'])) {
    ...
    $insert = mysqli_query($mysqli, "INSERT INTO tbl_barang_masuk(id_transaksi, tanggal, barang, jumlah, keterangan, id_nota) 
                                     VALUES('$id_transaksi', '$tanggal_masuk', '$barang', '$jumlah', '$keterangan', '$id_nota')")

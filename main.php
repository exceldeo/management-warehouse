<!-- Inventory Warehouse dengan PHP 8 dan MySQLi
************************************************************************
* Developer   : Excel Deo
* Company     : Excel Deo
* Release     : Mei 2021
...
// jika user sudah login, tampilkan halaman konten
  ...
  <head>
    ...
    <meta name="description" content="Inventory Warehouse dengan PHP 8 dan MySQLi" />
    <meta name="author" content="Excel Deo" />

    <!-- Title -->
    <title>Inventory Warehouse dengan PHP 8 dan MySQLi</title>
        ...
        <footer class="footer">
          <div class="container-fluid">
            <div class="copyright ml-auto">
              Copyright &copy; 2023 - <a href="#" class="text-secondary">Excel Deo</a>.
            </div>
          </div>
        </footer>
        <!-- End Footer -->
